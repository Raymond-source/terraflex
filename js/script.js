      ...
      <div class="container header-container">
        <a href="index.html" class="logo">
          <img
            ...
            class="logo-img"
          />
          <div class="logo-text">Terra<span>flex</span></div>
        </a>
  ...
  loadFooter: function () {
    ...
    footer.innerHTML = `
      ...
      siteConfig.email
        ...
        <div class="copyright">
          <p>
            &copy; <span class="current-year"></span> Terraflex. All rights
            reserved. Site by
            <a
              href="https://www.terraflex.co.za"
              target="_blank"
              rel="noopener noreferrer"
              class="terraflex-name"
              aria-label="Visit Terraflex website"
            >
...
window.initTerraflex = initTerraflex;
